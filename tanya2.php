  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div id="colorlib-container" style="background: #F7F7F7;" id="menu">
						...
						<div class="blog-entry">
							<div>
								...
								<form action="?.html #colorlib-container">
									<input type="submit" name="1" value="Fotosintesis memerlukan..."  class="buton tanyaa">
								</form></center>
							</div>
						</div>
					</div>	</center>
							</div>
				<form method="post" enctype="multipart/form-data" action="tanya2.php #colorlib-footer" >
				<div class="container">
				<div class="row row-pb-md">
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center >
									<input type="submit" name="1" value="Karbondioksida"  class="button satuu">
								</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="2" value="Zat besi"  class="button duaa">
								</center>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="3" value="Oksigen"  class="button tigaa">
							</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="4" value="Karbohidrat"  class="button empatt">
								</center>
							</div>
						</div>
					</div></form>
			...
			<td align="center"><form action="tanya3.php #colorlib-container" style="margin-left: 630px;">
