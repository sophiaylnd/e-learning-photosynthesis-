  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div id="colorlib-container" style="background: #F7F7F7;" id="menu">
						...
						<div class="blog-entry">
							<div>
								...
								<form action="?.html #colorlib-container">
									<input type="submit" name="1" value="Proses biokimia pembentukan karbohidrat dari bahan anorganik yang dilakukan oleh tumbuhan adalah"  class="buton tanyaa">
								</form></center>
							</div>
						</div>
					</div>	</center>
				...
				<div class="row row-pb-md">
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center >
									<input type="submit" name="1" value="Melahirkan"  class="button satuu">
								</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="2" value="Fotosintesis"  class="button duaa">
								</center>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="3" value="Penguapan"  class="button tigaa">
							</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="4" value="Menyublim"  class="button empatt">
								</center>
							</div>
					...
					<div class="col-md-12">
						<div class="blog-entry">
							<div>
								<center><br><br><br>
									<form id="sk">
						<input type="submit" name="" class="skor" value="<?php echo $poin ?>">
					</form>
			...
			<td align="center"><form action="tanya2.php #colorlib-container" style="margin-left: 630px;">
