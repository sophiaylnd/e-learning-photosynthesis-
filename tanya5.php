  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div id="colorlib-container" style="background: #F7F7F7;" id="menu">
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-8">
						<div class="blog-entry">
							<div>
								<center>
								<form action="?.html #colorlib-footer">
									<input type="submit" name="1" value="Faktor eksternal fotosintesis yaitu sebagai berikut, kecuali ... "  class="buton tanyaa">
								</form></center>
							</div>
						</div>
					</div>	</center>
				...
				<div class="row row-pb-md">
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center >
									<input type="submit" name="1" value="Kandungan air dan mineral"  class="button satuu">
								</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="2" value="Temperatur"  class="button duaa">
								</center>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="3" value="Klorofil"  class="button tigaa">
							</center>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="4" value="Kandungan CO2 dalam udara"  class="button empatt">
								</center>
							</div>
						</div>
					</div></form>
			...
			<td align="center"><form action="hasil.php #colorlib-container" style="margin-left: 630px;">
					<b><input type="submit" name="nxt" value="CEK HASIl" class="butonn" style="width: 120px; height: 40px;"></b>
				</form></td>
		</table>
