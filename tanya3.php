  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div id="colorlib-container" style="background: #F7F7F7;" id="menu">
						...
						<div class="blog-entry">
							<div>
								...
								<form action="?.html #colorlib-container">
									<input type="submit" name="1" value="Fungsi utama fotosintesis adalah untuk memproduksi ... "  class="buton tanyaa">
								</form></center>
							</div>
						</div>
					</div>	</center>
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="2" value="Air"  class="button duaa">
								</center>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="blog-entry">
							<div>
								<center>
									<input type="submit" name="4" value="Glukosa"  class="button empatt">
								</center>
							</div>
						</div>
					</div></form>
			...
			<td align="center"><form action="tanya4.php #colorlib-container" style="margin-left: 630px;">
